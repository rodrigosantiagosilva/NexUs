...
Um repositório do projeto **NexUs**. Este README traz uma visão geral do projeto, instruções gerais de uso, organização das pastas, tecnologias utilizadas e informações sobre créditos e licença.  
...
- `/` (root)  
  ...
  - `composer.json` / `package.json` — dependências e scripts  
...
**Autores Principais:**  
- Rodrigo Santiago Silva — [github.com/rodrigosantiagosilva](https://github.com/rodrigosantiagosilva)  

**Colaboradores:**  
- Mario Gonçalves de Freitas Jr  
- Rafael Carvalho Strauss  
- Vinicius Gabriel Inacio  
- Pedro Pelinson Gomes  
